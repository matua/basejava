...
- Реализуйте класс `com.matuageorge.webapp.storage.ArrayStorage`, организовав хранение резюме на основе массива с методами `save, get, delete, size, clear, getAll`
...
```
- Протестируйте вашу реализацию с помощью классов `com.matuageorge.webapp.MainArray.main()` и `com.matuageorge.webapp.MainTestArrayStorage.main()`
...
6. `com.matuageorge.webapp.model.Resume r` — давай переменным осмысленные имена, например `resume`. `r` допустимо в коротких циклах и лямбдах.
...
1. Не меняйте сигнатуры методов в `com.matuageorge.webapp.storage.ArrayStorage`
